               ...
               : base(options)
        {
            if (Database.EnsureCreated())
            {
                ...
                Coach c = new Coach { Name = "Иванов Иван", Login = "ivan", Password = hashedPassword,
                    ...
                    Gender = "мужской", Photo = "/Coaches/тренер6.jpg",
                    Post = p,
                    Speciality = sp,
                    Description = "Тренер по кроссфиту с 2-летним опытом работы в фитнес-клубе премиум-класса. Составил эффективный план индивидуальных тренировок для 15 клиентов клуба. Дважды занимал 1 место в областных соревнованиях по кроссфиту среди профессионалов. Получил более 50 положительных отзывов на сайте клуба."
                };
                Coach c1 = new Coach
                {
                    Name = "Сидорова Алена",
